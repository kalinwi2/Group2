public class Matcher {
   ...
   public static void main(String[] args) {
      ...
      String[] sentences = { "Tommorow, Jane will take Bill to the concert.", "Fred sat on a log.",
      ...
      if (found) {
         System.out.println("'" + name + "' was found in the sentence '" + sentence + "' at index=" + index);
      } else {
         System.out.println("'" + name + "' was not found in the sentence '" + sentence + "'");
      }
   }
}
